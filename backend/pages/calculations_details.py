...
def normalize_row(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    aliases = {
        'date': ['date', 'transaction date', 'trade date', 'settlement date', 'value date', 'start date', 'issue date', 'transactiondate', 'tradedate', 'settlementdate', 'valuedate', 'startdate', 'issuedate'],
        'instrument': ['instrument', 'security', 'name', 'description', 'asset', 'issuer', 'entity', 'company', 'ticker', 'symbol', 'counterparty'],
        'rate': ['rate', 'interest rate', 'coupon rate', 'discount rate', 'yield', 'return', 'apr', 'interestrate', 'couponrate', 'discountrate', 'annual rate', 'nominal rate'],
        'amount': ['amount', 'face value', 'facevalue', 'value', 'price', 'notional', 'principal', 'investment', 'face', 'nominal', 'par', 'principal amount', 'investment amount'],
        'maturity_date': ['maturitydate', 'maturity date', 'maturity', 'matures', 'end date', 'due date', 'expiry date', 'maturity_date', 'end_date', 'due_date', 'expiry_date'],
        'days_to_maturity': ['daystomaturity', 'days to maturity', 'tenor', 'days', 'term', 'duration days', 'term_days', 'termdays', 'duration', 'time to maturity'],
        'principal': ['principal', 'amount', 'face value', 'notional', 'investment amount', 'principal amount', 'initial investment', 'starting amount'],
        'interest_rate': ['interestrate', 'interest rate', 'rate', 'coupon', 'yield', 'annual rate', 'nominal rate', 'stated rate', 'coupon rate'],
        'discount_rate': ['discountrate', 'discount rate', 'discount', 'rate', 'bank discount', 'discount yield'],
        'price': ['price', 'market price', 'current price', 'purchase price', 'bid price', 'ask price', 'clean price', 'dirty price', 'currentprice', 'purchaseprice', 'marketprice'],
        'face_value': ['facevalue', 'face value', 'face', 'value', 'amount', 'principal', 'par value', 'nominal', 'par', 'notional amount'],
        'bond_name': ['bondname', 'bond name', 'bond', 'security', 'issuer', 'description', 'name', 'instrument name', 'security name'],
        'coupon_rate': ['couponrate', 'coupon rate', 'coupon', 'rate', 'interest rate', 'annual coupon', 'stated coupon', 'nominal coupon'],
        'yield': ['yield', 'yield to maturity', 'ytm', 'return', 'effective yield', 'current yield', 'annual yield', 'bond yield'],
        'issue_date': ['issuedate', 'issue date', 'issued', 'issuance date', 'start date', 'origination date', 'settlement date'],
        'frequency': ['frequency', 'payment frequency', 'coupon frequency', 'period', 'semiannual', 'quarterly', 'annual', 'semi-annual', 'payment period', 'coupon period'],
        'accrued_interest': ['accruedinterest', 'accrued interest', 'accrued', 'interest accrued', 'accrued amount'],
        'redemption_value': ['redemptionvalue', 'redemption value', 'call value', 'maturity value', 'redemption price', 'call price'],
        'tbill_name': ['tbillname', 't-bill name', 'tbill', 't bill', 'security', 'instrument', 'treasury bill', 'treasury', 'bill name'],
        'purchase_price': ['purchaseprice', 'purchase price', 'buy price', 'price paid', 'acquisition price', 'entry price'],
        'term_days': ['termdays', 'term_days', 'term days', 'days', 'tenor', 'duration days', 'maturity days', 'time to maturity days'],
        'current_price': ['currentprice', 'current_price', 'price', 'market price', 'trading price', 'spot price'],
        'years_to_maturity': ['yearstomaturity', 'years_to_maturity', 'years', 'maturity years', 'time to maturity years', 'remaining years'],
