...
/**
 * Enhanced intelligent parser that extracts required fields from Excel files regardless of layout.
 * Supports multiple worksheets, tables, unstructured layouts, merged cells, label/value pairs,
 * summary blocks, and semantic extraction by labels/keywords/positioning.
 * @param {File} file - The Excel file to parse.
 * @param {string} instrumentType - 'money-market', 'bonds', or 'tbills'.
 * @returns {Promise<Object>} Object with { data: Array, warnings: Array, metadata: Object }
 */
