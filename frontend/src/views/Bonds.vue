...
const { fredFilters, filterOptions, countryItems, currencyItems, maturityItems, loadFilterOptions, onCountryChange, seriesIdForMaturity, fetchBenchmark } = useFredMarket('10Y')
